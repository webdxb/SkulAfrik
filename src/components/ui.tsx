...
export const inputCls = 'w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none';

export function inputErrorCls(hasError: boolean) {
  return hasError
    ? 'w-full rounded-lg border border-rose-300 px-3 py-2 text-sm focus:border-rose-500 focus:ring-1 focus:ring-rose-500 outline-none'
    : inputCls;
}
