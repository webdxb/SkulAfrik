...
const fr: Dict = {
  ...
  'hero.subtitle': 'SKUL AFRIK connecte administrateurs, enseignants, parents et élèves dans une plateforme unique, pensée pour l\'Afrique et prête pour le monde.',
  ...
  'auth.login.title': 'Connexion à SKUL AFRIK',
...
const en: Dict = {
  ...
  'hero.subtitle': 'SKUL AFRIK connects administrators, teachers, parents and students in a single platform built for Africa and ready for the world.',
  ...
  'cookies.marketing': 'Marketing',
  'auth.login.title': 'Sign in to SKUL AFRIK',
